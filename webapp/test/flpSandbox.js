		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "invoice_scan",
									"targetURL": "#invoicescaninvoicescan-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"invoicescaninvoicescan-display": {
								"semanticObject": "invoicescaninvoicescan",
								"action": "display",
								"description": "A Fiori application for invoice_scan",
								"title": "invoice_scan",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=invoicescan.invoicescan",
									"url": sap.ui.require.toUrl("invoicescan/invoicescan")
								}
							}
						}
					}
